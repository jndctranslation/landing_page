...
<div class="full_width_banner home_banner clearfix" id="home-banner-instant">
  <div class="carousel-inner">
    <div id="particles-js" class="item active" style="background-image: url({{ site.data.pages.home.block_1.background_image }});
        ...
        <div class="container">
          <div class="text_wrap">
            ...
            <div class="btn_wrap">
              ...
              <a class="btn btn-md btn_maroon" href="{{site.data.header.primary_nav.button_1.link}}"
                id="home-banner-instant">{{site.data.header.primary_nav.button_1.name}}</a>
              {% endif %}
              {% if site.data.header.primary_nav.button_2.visible == true %}
              <a class="btn btn-md btn_white_fill" href="{{site.data.header.primary_nav.button_2.link}}"
                id="home-banner-order">{{site.data.header.primary_nav.button_2.name}}</a>
              {% endif %}
            </div>
          </div>
        </div>
...
<div class="content_web">
  <section class="section_grey_bg pd_lg clearfix" style="background-image: url({{ site.data.pages.home.block_2.background_image }});
  ...
  <section class="section_white_bg qualities_block pd_lg clearfix" style="background-image: url({{ site.data.pages.home.block_3.background_image }});
  ...
  <section class="section_green_bg success_block clearfix" style="background-image: url({{ site.data.pages.home.block_4.background_image }});
  ...
  {% endif %}">
    <div class="container">
      <div class="text_row text-center">
        ...
        <div class="btn_wrap"><a class="btn btn_white_fill"
            href="{{site.data.pages.home.block_4.button.link}}">{{site.data.pages.home.block_4.button.name}}</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="content_web expert_transaltion_services_page">
    ...
    {% endif %}">
      <div class="container">
        <div class="text_row text-center">
          <h3 class="heading">{{site.data.pages.home.block_5.title }}</h3>
          <div class="desc">{{site.data.pages.home.block_5.text | markdownify }}</div>
        </div>
  ...
  <section class="section_white_bg languages_intro_block pd_lg clearfix" style="background-image: url({{ site.data.pages.home.block_6.background_image }});
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-xs-12">
          ...
          <div class="btn_wrap"><a class="btn btn_maroon2"
              href="{{site.data.pages.home.block_6.button.link}}">{{site.data.pages.home.block_6.button.name}}</a></div>
        </div>
  ...
  <section class="section_grey_bg api-integration-block clearfix" style="background-image: url({{ site.data.pages.home.block_7.background_image }});
  ...
  {% endif %}">
    <div class="container">
      <div class="col-sm-6 col-xs-12 pull-right">
        ...
        <a class="btn btn_maroon2"
          href="{{site.data.pages.home.block_7.button.link}}">{{site.data.pages.home.block_7.button.name}}</a>
      </div>
      <div class="col-sm-6 col-xs-12">
        <img class="img-responsive" src="{{site.data.pages.home.block_7.image}}" alt="api integration">
      </div>
    </div>
  </section>

  <section class="section_white_bg customer_feedback_with_multiple_slides clearfix" style="background-image: url({{ site.data.pages.home.block_8.background_image }});
          ...
          <li class="items main-pos" id="{{ forloop.index }}">
            <div class="review-card review-card--option-4 text-center">
              <div class="review-card-img">
                <img src="{{customer.avatar}}" class="img-responsive img-circle" onerror="imgError(this)"
                  alt="client" />
              </div>
              ...
              <a class="more_testmonial"
                href="{{ site.data.pages.home.block_8.button.link}}">{{ site.data.pages.home.block_8.button.name}}</a>
            </div>
          </li>
          {% endfor %}
  ...
  <section class="section_grey_bg translator_intro_block pd_lg clearfix" style="background-image: url({{ site.data.pages.home.block_9.background_image }});
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-xs-12">
          ...
          <div class="btn_wrap"><a class="btn btn_maroon2"
              href="{{site.data.pages.home.block_9.button.link}}">{{site.data.pages.home.block_9.button.name}}</a></div>
        </div>
  ...
  <section class="section_white_bg info_panels_block pd_lg clearfix" style="background-image: url({{ site.data.pages.home.block_10.background_image }});
